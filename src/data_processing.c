...
void updateInventory(struct Inventory *data,int id,struct Inventory updatedData ,const char* filePath){
    ...
    if(index == -1){
        ...
        data[index].item_id = updatedData.item_id;
        data[index].supplier_id = updatedData.supplier_id;
        data[index].quantity = updatedData.quantity;
...
void updateSupplier(struct Supplier *data,struct Supplier updatedData,int id ,const char* filePath){
    ...
    if(index == -1){
        ...
        data[index].id = updatedData.id;
        strcpy(data[index].name,updatedData.name);
        strcpy(data[index].phone_number,updatedData.phone_number);
...
void updateItem(struct Item *data,struct Item updatedData,int id ,const char* filePath){
    ...
    if(index == -1){
        ...
        data[index].id = updatedData.id;
        strcpy(data[index].item_name,updatedData.item_name);
        data[index].price = updatedData.price;        
